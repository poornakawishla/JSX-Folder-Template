...
function Homepage() {
  ...
  return (
    <>
      <div className="relative bg-gradient-to-r from-[#18233d] via-[#10182A] to-[#10182A] bg-[length:400%_400%] animate-gradient-x text-white min-h-screen">
          ...
          <div className="relative z-10 max-w-4xl text-center space-y-8 w-full">
            ...
            <div className="space-y-6 text-left max-w-xl mx-auto mt-10">
              {visibleProjects.map((project, index) => (
                <div
                  key={index}
                  className="bg-[#1b2238] p-6 rounded-lg shadow-lg w-full"
                >
